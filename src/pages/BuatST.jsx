...
// Puldadis/PuldadisDesa: tanggal ST <= tanggal mulai (inklusif, boleh sama dgn tgl mulai)
// PL/Sidang: setelah tanggal mulai, sebelum tanggal pengumuman
    ...
    <div className="border border-gray-200 rounded-lg p-3 bg-white">
      ...
      {jenisValue === 'PULDADIS' || jenisValue === 'PULDADIS_DESA' ? (
        <p className="text-xs text-blue-600 mt-1.5 bg-blue-50 rounded px-2 py-1">
          Tanggal ST harus &le; Tanggal Mulai ({tglMulai})
        </p>
      ) : (
        <p className="text-xs text-blue-600 mt-1.5 bg-blue-50 rounded px-2 py-1">
